...
* `events` array of dates that you would like to differentiate from regular days (e.g. `['Sat Jun 28 2017', 'Sun Jun 29 2017', 'Tue Jul 01 2017',]`). Alternatively you can pass an object of date / class pairs such as `{'Sat Jun 28 2017': 'high-priority', 'Sun Jun 29 2017': 'low-priority'}` to apply user defined classes to event cells.
